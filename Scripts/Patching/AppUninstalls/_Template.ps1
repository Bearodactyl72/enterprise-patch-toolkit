...
# TEMPLATE: Add app-specific process kills here if needed, e.g.:
# cmd /c 'TaskKill /F /T /IM "SomeProcess.exe"'
...
# =============================================================================
# TEMPLATE: App-Specific Section
# =============================================================================
# This is where app-specific cleanup goes. Examples from existing scripts:
#
#   - Registry key cleanup (HKCR, vendor-specific keys)
#   - ACL/permission changes for locked folders
#   - File/folder deletion (Remove-Item, rmdir)
#   - Additional process kills mid-script
#   - PSDrive creation for HKCR access
#
# Log each significant action to $actionLog for tracking:
#
#   $actionStart = Get-Date
#   $sw = [System.Diagnostics.Stopwatch]::StartNew()
#   # ... your action here ...
...
#   $actionEntry = [PSCustomObject]@{
#       Phase     = 'Cleanup'
#       Command   = 'Description of what was done'
#       ExitCode  = $exitCodeOrNull
#       Duration  = $sw.Elapsed.ToString()
#       Source    = 'AppSpecific'
#       StartTime = $actionStart
#       EndTime   = $actionEnd
