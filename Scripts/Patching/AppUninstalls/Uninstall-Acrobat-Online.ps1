...
# =============================================================================
# Uninstall-Acrobat-Online.ps1
# =============================================================================
# Handles MSI uninstall + reinstall of Adobe Acrobat (online deployment variant).
# This script may target the same product as Uninstall-Acrobat.ps1 delivered via
# a different installer channel. If "Acrobat Online" is confirmed as a distinct
# product, add product-specific cleanup below the uninstall section.
#
# Process kills: Acrobat and CC updater processes ONLY.
# Does NOT kill FrameMaker, AcroRd32 (Reader), or Office processes.
# =============================================================================
...
# Acrobat and CC updater processes only
# Does NOT kill AcroRd32 (Reader), FrameMaker, or FM
$acrobatOnlineProcs = @(
    'Acrobat'
    'AcroCEF'
    'AcroBroker'
...
foreach ($proc in $acrobatOnlineProcs) {
...
Write-ProcessSnapshot "After Cleanup" -Extra $acrobatOnlineProcs
